This project uses Raylib which is is licensed under an unmodified zlib/libpng license.
...
Do note that there is a multithreaded version on a separate branch from main that is ahead of main by quite a bit.
